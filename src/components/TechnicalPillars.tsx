...
import { Server, Network, Shield, Cpu, ChevronRight, Terminal, CheckCircle2, Layers } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#0b101d] border border-cyan-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {/* Protocols, Stack & Terminal Command Preview */}
            <div className="lg:col-span-5 space-y-5 bg-[#070a12] p-5 rounded-xl border border-slate-800">
              ...
              <div className="pt-3 border-t border-slate-800">
                <div className="flex items-center justify-between text-[11px] font-mono text-slate-400 mb-2">
                  <span>SAMPLE CLI DIAGNOSTIC</span>
                  <span className="text-cyan-400 font-bold">READY</span>
                </div>
                <div className="bg-black/90 p-3 rounded-lg border border-slate-800/80 font-mono text-xs text-emerald-400 flex items-center gap-2 overflow-x-auto">
                  <Terminal className="w-3.5 h-3.5 shrink-0 text-slate-500" />
                  <code>{activePillar.terminalCommand}</code>
                </div>
              </div>
            </div>
