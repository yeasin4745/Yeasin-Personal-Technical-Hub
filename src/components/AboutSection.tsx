...
import { User, Terminal, Shield, Network, Server, MapPin, Mail, GitFork, Check } from 'lucide-react';
import { PERSONAL_INFO } from '../data/portfolioData';
import { ProfileImage } from './ProfileImage';

export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-[#080c14] border-t border-b border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          
          {/* Left Column: Personal Identity & Overview */}
          ...
          {/* Right Column: Philosophy & Detailed Background */}
          <div className="lg:col-span-7 space-y-6 text-sm text-slate-300 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="bg-[#0b101c] p-4 rounded-xl border border-slate-800 space-y-1.5">
