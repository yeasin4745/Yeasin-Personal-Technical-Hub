...
import { BookOpen, FileCode, CheckCircle, Clock, ExternalLink, Milestone, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {RESEARCH_ITEMS.map((item) => (
            <div
              key={item.id}
              className="bg-[#0c111e] border border-slate-800 hover:border-indigo-500/40 rounded-xl p-6 transition-all duration-200 flex flex-col justify-between"
            >
              <div>
