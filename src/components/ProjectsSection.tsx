...
import { GitFork, ExternalLink, ShieldAlert, CheckCircle, Clock, AlertCircle, Code2 } from 'lucide-react';
  ...
  return (
    <section id="projects" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 p-4 rounded-xl bg-gradient-to-r from-[#0d1424] to-[#0a0f1b] border border-cyan-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
